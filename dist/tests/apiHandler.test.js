...
const dynamoHelper = __importStar(require("../dynamodb/dynamoHelper"));
describe('API Handler', () => {
    test('Should store data in DynamoDB', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield (0, lambda_1.handler)({ body: JSON.stringify(testData) });
        // Assert response
